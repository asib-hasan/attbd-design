<template>
  <!-- Top Info Bar -->
  <div class="hidden md:block bg-primary-700 text-white/90 text-xs py-2">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 lg:h-20">
        ...
        <nav class="hidden lg:flex items-center gap-4 lg:gap-6">
          <NuxtLink to="/about" :class="navLinkClass" active-class="!text-accent-500">About Us</NuxtLink>
          <NuxtLink to="/solutions" :class="navLinkClass" active-class="!text-accent-500">Solutions</NuxtLink>
          <NuxtLink to="/products" :class="navLinkClass" active-class="!text-accent-500">Products</NuxtLink>
          <NuxtLink to="/services" :class="navLinkClass" active-class="!text-accent-500">Services</NuxtLink>
          <NuxtLink to="/projects" :class="navLinkClass" active-class="!text-accent-500">Projects</NuxtLink>
          <NuxtLink to="/blogs" :class="navLinkClass" active-class="!text-accent-500">Newsfeed</NuxtLink>
...
const navLinkClass = 'font-bold text-primary-700 hover:text-primary-800 text-[15px] whitespace-nowrap transition-colors'
